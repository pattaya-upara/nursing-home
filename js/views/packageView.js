const PackageView = (() => {
    return {
        ...
        renderDetail: (pkg) => {
            // App.showDetail will wrap this in <app-sidesheet>
            return `
                <div slot="left">
                    <!-- TOP: Package Details -->
                    <section class="mb-4">
                        ...
                        ${pkg.services && pkg.services.length > 0 ? pkg.services.map(s => `
                            <div class="list-group-item px-0 py-3 border-bottom">
                                <div class="d-flex justify-content-between align-items-start">
                                    ...
                                    <span class="badge tertiary extra-small">${s.dept}</span>
                                </div>
            ...
            return `
                <div slot="left">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control bg-light border p-3 fw-bold" name="name" required form="sidesheet-form"
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control bg-light border-start-0 p-3 fw-bold" name="price" form="sidesheet-form"
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control bg-light border-end-0 p-3 fw-bold" name="duration" required form="sidesheet-form"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control bg-light border p-3 text-secondary" name="description" rows="5" form="sidesheet-form"
